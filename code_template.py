...
def gen_toxml_function(class_name):
    def toxml_content(member_name, member_type):
        if member_name.endswith(".Tags") and member_type == "std::map<std::string, std::string>":
            ...
            content = "writer.Write(_internal::XmlNode{{_internal::XmlNodeType::Text, nullptr, {}.data()}});".format(member_name)
        elif member_type == "bool":
            content = "writer.Write(_internal::XmlNode{{_internal::XmlNodeType::Text, nullptr, {} ? \"true\":\"false\"}});".format(member_name)
        elif member_type == "Azure::DateTime(ISO8601)":
            content = "writer.Write(_internal::XmlNode{{_internal::XmlNodeType::Text, nullptr, {}.ToString(Azure::DateTime::DateFormat::Rfc3339, Azure::DateTime::TimeFractionFormat::AllDigits).data()}});".format(member_name)
        elif member_type == "Azure::DateTime(ISO8601t)":
            content = "writer.Write(_internal::XmlNode{{_internal::XmlNodeType::Text, nullptr, {}.ToString(Azure::DateTime::DateFormat::Rfc3339, Azure::DateTime::TimeFractionFormat::Truncate).data()}});".format(member_name)
        elif member_type == "Azure::DateTime(RFC1123)":
            content = "writer.Write(_internal::XmlNode{{_internal::XmlNodeType::Text, nullptr, {}.ToString(Azure::DateTime::DateFormat::Rfc1123).data()}});".format(member_name)
        elif member_type in ["int32_t", "int64_t"]:
            content = "writer.Write(_internal::XmlNode{{_internal::XmlNodeType::Text, nullptr, std::to_string({}).data()}});".format(member_name)
        else:
