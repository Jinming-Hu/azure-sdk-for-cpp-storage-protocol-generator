...
// TODO: Think about how to free object
auto body_buffer = new azure::core::http::BodyBuffer(static_cast<const uint8_t*>(xml_dump), xml_dump_size);
request.setBodyBuffer(body_buffer);
// TODO: Set Content-MD5 or x-ms-content-crc64 header
request.addHeader("Content-Length", std::to_string(body_buffer->_bodyBufferSize));
